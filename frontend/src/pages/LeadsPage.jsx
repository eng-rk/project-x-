...
const statusBadge = (status) => {
  const map = { New: 'badge-new', Contacted: 'badge-contacted', Qualified: 'badge-qualified', Confirmed: 'badge-qualified', Won: 'badge-converted', Lost: 'badge-lost', Converted: 'badge-converted' };
  return map[status] || 'badge-new';
};
const sourceBadge = (src) => (src === 'Meta' || src === 'Meta Ads') ? 'badge-meta' : (src === 'Google' || src === 'Google Ads') ? 'badge-google' : 'badge-new';

const STATUSES = ['New', 'Contacted', 'Qualified', 'Confirmed', 'Won', 'Lost', 'Converted'];
