...
const COLUMNS = [
  ...
  { id: 'Confirmed', label: 'Confirmed', icon: 'check', color: '#a855f7' },
  { id: 'Won',       label: 'Won',       icon: 'rocket', color: '#10b981' },
  { id: 'Converted', label: 'Converted', icon: 'check', color: '#22c55e' },
  { id: 'Lost',      label: 'Lost',      icon: 'close', color: '#ef4444' },
];

const sourceBadgeStyle = (src) => {
  const isMeta = src === 'Meta' || src === 'Meta Ads';
  return {
    background: isMeta ? 'rgba(24,119,242,0.15)' : 'rgba(219,68,55,0.15)',
    color: isMeta ? '#4e8ef0' : '#e06355',
  };
};
