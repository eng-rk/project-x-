                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20, paddingBottom: 16, borderBottom: '1px solid var(--border-color)' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        {contract?.signedContractFile ? (
                          <a href={`${(import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000/api').replace('/api', '')}${contract.signedContractFile}`} target="_blank" rel="noopener noreferrer"
                                ...
                                {docUrl && (
                                  <div style={{ fontSize: 11, marginTop: 3 }}>
                                    {docUrl.startsWith('/uploads') ? (
                                      <a
                                        href={`${(import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000/api').replace('/api', '')}${docUrl}`}
                                        target="_blank"
